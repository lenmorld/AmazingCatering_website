...
<body>
<div id="container">
<div id="wb_Image1" style="position:absolute;left:90px;top:220px;width:855px;height:585px;z-index:0;">
...
<div id="wb_TextArt2" style="position:absolute;left:108px;top:238px;width:304px;height:31px;z-index:5;">
<img src="images/img0005.png" id="TextArt2" alt="Event Mangement" title="Event Mangement" style="border-width:0;width:304px;height:31px;"></div>
...
<div id="wb_Image2" style="position:absolute;left:312px;top:288px;width:400px;height:269px;z-index:8;">
<img src="images/425359_409580755734539_176475585_n.jpg" id="Image2" alt="" border="0" style="width:400px;height:269px;"></div>
<div id="wb_Text1" style="position:absolute;left:301px;top:593px;width:441px;height:135px;z-index:9;">
<span style="color:#000000;font-family:'Palatino Linotype';font-size:20px;"><strong>We are devoted to make event preparation very easy and exciting for you. We can organize any event, including birthdays, debuts, weddings, Christenings, parties, family gatherings, or any occasion that you want to celebrate amazingly.</strong></span><span style="color:#4B0082;font-family:'Palatino Linotype';font-size:20px;"><strong> </strong></span></div>
</div>
</body>
</html>